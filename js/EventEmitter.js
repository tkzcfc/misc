        ...
        for (let i = 0; i < listenerTabArr.length; ++i) {
            ...
            for (let j = 0; j < listenerTab.length; ++j) {
                ...
                if (listener.count != 0) {
                    ...
                    case 1:
                        abort = listener.handler.call(listener.context);
                        break;
                    case 2:
                        abort = listener.handler.call(listener.context, arg0);
                        break;
                    case 3:
                        abort = listener.handler.call(listener.context, arg0, arg1);
                        break;
                    case 4:
                        abort = listener.handler.call(listener.context, arg0, arg1, arg2);
                        break;
                    case 5:
                        abort = listener.handler.call(listener.context, arg0, arg1, arg2, arg3);
                        break;
                    case 6:
                        abort = listener.handler.call(listener.context, arg0, arg1, arg2, arg3, arg4);
                        break;
                    default:
                        {
                            let args = [];
...
let handle = emitter.on("event_test_off", function(arg){
  console.log("on emit event_test_off", arg)
})

emitter.emit("event_test_off", "emit 1")
emitter.off(handle);
emitter.emit("event_test_off", "emit 2")
